...
import com.golf.model.AuthorisationManager;
import com.golf.model.UsersProvider;
...
public class AuthorisationControllerTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        Parent mainNode = FXMLLoader.load(ViewSetupManager.class.getResource("/Login.fxml"));
