...
public class ViewSetupManager {
    ...
    public void showLogin() throws IOException {
        try{
            ...
            setPrimaryStageSceneFromPathToFxmlFile("/Golf/src/main/resources/view/Login.fxml",primaryStage);
    ...
    public void showTaskOverview(){
        try{
            ...
            setPrimaryStageSceneFromPathToFxmlFile("/Golf/src/main/resources/view/TaskOverview.fxml",primaryStage);
    ...
    public boolean showTaskEdit(TaskModel taskToEdit){
        try {
            ...
            setPrimaryStageSceneFromPathToFxmlFile("/Golf/src/main/resources/view/TaskEdit.fxml",dialogStage);
